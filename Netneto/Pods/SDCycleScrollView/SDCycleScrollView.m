...
@property (nonatomic, weak) BannerPageControl *pageControl;
...
//    if ([self.pageControl isKindOfClass:[BannerPageControl class]]) {
//        BannerPageControl *pageContol = (BannerPageControl *)_pageControl;
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        {
            BannerPageControl *pageControl = [[BannerPageControl alloc] init];
...
- (void)layoutSubviews
{
    ...
    _flowLayout.itemSize = CGSizeMake(self.frame.size.width, self.frame.size.height - 18);
    
    _mainView.frame = CGRectMake(0, 0, self.frame.size.width, self.frame.size.height - 18);
    ...
    if ([self.pageControl isKindOfClass:[BannerPageControl class]]) {
        BannerPageControl *pageControl = (BannerPageControl *)_pageControl;
...
//        size = [pageControl sizeForNumberOfPages:self.imagePathsGroup.count];
    ...
    CGRect pageControlFrame = CGRectMake(x, self.sd_height -size.height - 10 , size.width, size.height);
