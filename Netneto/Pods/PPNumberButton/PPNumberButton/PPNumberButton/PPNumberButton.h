...
@property (nonatomic, copy) void(^customBlock)(PPNumberButton *ppBtn,CGFloat number, BOOL increaseStatus/* 是否为加状态*/);
...
@property (nonatomic, strong ) IBInspectable NSString *proID;
@property (nonatomic, strong ) IBInspectable NSString *skuid;
@property (nonatomic, strong ) IBInspectable NSString *accessToken;
/** 输入框中的内容 */
...
/** 限购 */
@property (nonatomic, assign ) NSInteger limValue;
/** 目前支持一位小数的递增 */
