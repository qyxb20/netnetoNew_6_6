...
@implementation MsgLeftTableViewCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.contentLabel.textColor = RGB(0x1D2122);
...
- (void)layoutSubviews{
    ...
    if (self.timeLabel.hidden) {
        self.bgView.frame = CGRectMake(16, 10, w + 10, h + 10);
        
    }
    else{
        self.bgView.frame = CGRectMake(16, self.timeLabel.bottom + 10, w + 10, h + 10);
       
    }
    
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:self.bgView.bounds byRoundingCorners:UIRectCornerBottomLeft | UIRectCornerTopRight| UIRectCornerBottomRight cornerRadii:CGSizeMake(16,16)];
