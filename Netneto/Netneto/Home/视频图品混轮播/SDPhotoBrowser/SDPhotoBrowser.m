...
- (void)layoutSubviews
{
    ...
    CGFloat statuH = rectOfStatusbar.size.height;
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, statuH+10);
    _saveButton.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 80, [UIScreen mainScreen].bounds.size.height - 59, 80, 50);
}
